    ...
    <footer>
        <div class="footer__content">
            ...
            <nav class="footer__contacts">
                ...
                <a class="footer__contact">Агенство</a>
                <a class="footer__contact">Блог</a>
                <a class="footer__contact" href="mailto:hello@cyberia.studio">
                    hello@cyberia.studio
                </a>
                <a class="footer__contact">Услуги</a>
                <a class="footer__contact">Контакты</a>
                <p class="footer__contact">ул. Ярных, д. 35, оф. 10</p>
                <a>Кейсы</a>
            </nav>
        </div>
    </footer>
